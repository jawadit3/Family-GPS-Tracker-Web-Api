...
namespace Family_GPS_Tracker_Api.Controllers
{
	...
	public class LocationController : ControllerBase
	{
		...
		public async Task<ActionResult<Response<LocationDto>>> CreateLocationAsync([FromRoute]Guid childId, [FromBody]CreateLocationDto createLocationDto)
		{
		...
		public async Task<ActionResult<LocationDto>> GetLocationByChildIdAsync(Guid childId)
		{
		...
		public async Task<ActionResult<Response<LocationDto>>> GetLastLocationByChildIdAsync(Guid childId)
		{
		...
		public async Task<ActionResult<Response<IEnumerable<LocationDto>>>> GetLastTenLocationsByChildIdAsync(Guid childId)
		{
