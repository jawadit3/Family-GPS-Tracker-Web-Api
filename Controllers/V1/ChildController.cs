...
namespace Family_GPS_Tracker_Api.V1.Controllers
{
	...
	public class ChildController : ControllerBase
	{
		...
		public async Task<ActionResult<Response<ChildResponse>>> GetChildByIdAsync([FromRoute] Guid childId)
		{
		...
		public async Task<ActionResult<Response<ChildDetailResponse>>> GetChildDetailsByIdAsync(Guid id)
		{
			Child child = await _childRepository.GetChildDetailsByIdAsync(id);
			if (child is null)
			{
		...
		public async Task<ActionResult<Response<PairingCodeResponse>>> GetPairingCodeAsync([FromRoute] Guid childId)
		{
