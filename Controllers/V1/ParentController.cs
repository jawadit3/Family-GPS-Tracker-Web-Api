...
namespace Family_GPS_Tracker_Api.V1.Controllers
{
	...
	public class ParentController : ControllerBase
	{
		...
		public async Task<ActionResult<Response<ParentDetailResponse>>> GetParentDetailsById([FromRoute] Guid parentId)
		{
		...
		public async Task<ActionResult<Response<DeviceTokenResponse>>> UpdateDeviceToken([FromRoute] Guid parentId, [FromBody] UpdateDeviceTokenRequest updateDeviceTokenRequest)
		{
		...
		public async Task<ActionResult<Response<ParentDetailResponse>>> LinkChildAsync([FromRoute] Guid parentId, [FromBody] PairingCodeRequest pairingCodeRequest)
		{
			var parent = await _parentRepository.GetParentByIdAsync(parentId);
			if (parent == null)
			{
