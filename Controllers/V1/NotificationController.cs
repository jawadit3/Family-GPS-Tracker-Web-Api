...
namespace Family_GPS_Tracker_Api.V1.Controllers
{
	...
	public class NotificationController : ControllerBase
	{
		...
		public async Task<ActionResult> GetNotificationsByParentIdAsync([FromRoute] Guid parentId) {
		...
		public async Task<ActionResult> GetNotificationsByChildIdAsync([FromRoute] Guid childId)
		{
